...
public class ResolutionOfRHSPartReferencesTest extends CommonTestMethodBase {
    ...
    /**
     * Setup for {@link ResolutionOfRHSPartReferencesTest#noNullResources()}
     */
    ...
    private Map<String, Set<String>> compileResourceAndGetTypeReferences(String... pathDrlStringPairs) {
        ...
        // build!
        assertTrue( "Errors found when compiling rule!", kBuilder.buildAll().getResults().getMessages().isEmpty() );
       ...
       if( methodName.equals("visit") ) {
           ...
           if( firstParamType.contains("Reference") ) {
               switch(firstParamType) {
                   ...
                   case "ParameterizedQualifiedTypeReference":
                      return true;
               }
