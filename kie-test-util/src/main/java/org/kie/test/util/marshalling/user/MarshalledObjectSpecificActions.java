 ...
 */
package org.kie.test.util.marshalling.user;

import org.kie.test.util.marshalling.InternalMarshalledObjectSpecificActions;
import org.kie.test.util.marshalling.MarshalledData;
